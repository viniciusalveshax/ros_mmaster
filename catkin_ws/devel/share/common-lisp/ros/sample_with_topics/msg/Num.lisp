...
(cl:in-package sample_with_topics-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sample_with_topics-msg:<Num> is deprecated: use sample_with_topics-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sample_with_topics-msg:num-val is deprecated.  Use sample_with_topics-msg:num instead.")
  (num m))
